...
class TestGC:
    ...
    def main(self, feq):
        ...
        desired_js_origin = np.array([ -0.007611615714169705 , -0.017019065670751857 , 0.24301511551252092 , 0.0 , 0.0 , 0.0 ])
        desired_js_target = np.array([ -0.776629626276987 , 0.05401146354139197 , 0.1955039338232129 , 0.0 , 0.0 , 0.0 ])



        arm.move_jp(desired_js_origin).wait()
        arm.move_jp(desired_js_target).wait()
